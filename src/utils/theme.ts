...
/** Catppuccin Mocha theme via ansis.extend() — use named methods for all color output. */
/**
...
/** cli-table3 char config for borderless tables with no internal dividers. */
export const BORDERLESS_CHARS = {
	top: "",
	"top-mid": "",
	"top-left": "",
	"top-right": "",
